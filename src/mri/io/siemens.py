...
def read_rawdat(filename: str, removeOS: bool = False, squeeze: bool = True,
    ...
    hdr = {
        "num_coils": twixObj.image.NCha,
        "num_shots": twixObj.image.NLin,
        "num_contrasts": twixObj.image.NSet,
        "num_adc_samples": twixObj.image.NCol,
        "num_slices": twixObj.image.NSli,
    }
    data = data.reshape(
        hdr["num_coils"], 
